...
export const Analytics = () => {
    ...
    // Envoi des vues vers Google Analytics
    ...
    // Envoi des vues vers les analyses internes de Hashnode
    ...
    // Envoi des vues vers le tableau de bord avancé
    ...
    // Hook useEffect avec dépendances correctes
    useEffect(() => {
        if (!isProd) return;
