...
export default async function handler(req: NextRequest) {
    const [fontDataRegular, fontDataMedium] = await Promise.all([fontRegular, fontMedium]);
    ...
    return new ImageResponse(
        (
            <div>
                <img src={photoUrl} alt="Profile" style={{ width: '64px', height: '64px', borderRadius: '50%' }} />
            </div>
        ),
        {
            width: 1200,
